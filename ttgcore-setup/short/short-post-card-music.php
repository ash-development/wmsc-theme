...
if(!function_exists('qantumthemes_post_cardsM')) {
	function qantumthemes_post_cardsM($atts){
		...
		if ( $wp_query->have_posts() ) : while ( $wp_query->have_posts() ) : $wp_query->the_post();
			...
			switch ($posttype){
				...
				case "radiochannel":
					...
					break;
				default:
					$template =  'phpincludes/part-archive-item-post-vertical-music';
...
if(function_exists('ttg_custom_shortcode')) {
	ttg_custom_shortcode("qt-post-cardsM","qantumthemes_post_cardsM");
}
 ...
 */
add_action( 'vc_before_init', 'qantumthemes_vc_post_cardsM' );
if(!function_exists('qantumthemes_vc_post_cardsM')){
function qantumthemes_vc_post_cardsM() {
  vc_map( array(
	 "name" => esc_html__( "Post Cards M", "onair2" ),
	 "base" => "qt-post-cardsM",
