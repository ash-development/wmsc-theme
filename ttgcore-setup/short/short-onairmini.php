...
/*
Package: OnAir2
Description: Current on air show
Version: 2.0.0
Author: QantumThemes
		...
		if($id_of_currentday != 0){
			...
			if(is_array($events)){
				...
				foreach($events as $event){ 
					$neededEvents = array('show_id','show_time','show_time_end', 'show_subtitle');
					...
					$show_subtitle = get_post_meta($show_id, 'subtitle', true);
                    if(empty($show_subtitle)){
                        $show_subtitle = '';
                    }
								...
								<?php if (has_post_thumbnail($show_id)){ ?>
						     	...
						     	<div class="qt-nowonairmini-content">
                                    <a href="<?php echo get_the_permalink($show_id); ?>">
                                        <h4><?php echo get_the_title($show_id); ?></h4>
                                    </a>

                                    <h5 class="qt-onair-dj">
                                        <strong>DJ</strong>: <?php echo esc_attr($show_subtitle); ?>
                                    </h5>

                                    <h6 class="qt-onair-time">
                                        <?php echo esc_attr($show_time_d); ?>
                                        <i class="dripicons-arrow-thin-right"></i>
                                        <?php echo esc_attr($show_time_end_d); ?>
                                    </h6>
                                </div>
					     	</div>
